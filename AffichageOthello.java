public class AffichageOthello{
		...
		private String[][] tabAffichageJeu;
		...
		public AffichageOthello(int[][] tabPionJeu){		
			...
			tabAffichageJeu = new String[taille[0]][taille[1]];
		...
		public void dessinplateau(){
			...
			for(int ligne = 0; ligne<tabAffichageJeu.length;ligne++){
				tabAffichageJeu[ligne][1] = " " ;
				tabAffichageJeu[ligne][0] = " " ;
				tabAffichageJeu[ligne][3] = " " ;
			}
			for(int col = 0; col<tabAffichageJeu[0].length;col ++){
				tabAffichageJeu[1][col] = " " ;
				tabAffichageJeu[0][col] = " " ;
			}
		}
